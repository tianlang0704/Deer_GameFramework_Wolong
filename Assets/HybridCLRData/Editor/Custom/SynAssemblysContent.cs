...
public class SynAssemblysContent
{
    ...
    static void EditorUpdate()
    {
        ...
        if (DeerSettingsUtils.HybridCLRCustomGlobalSettings != null && SettingsUtil.HotUpdateAssemblyFilesIncludePreserved != DeerSettingsUtils.HybridCLRCustomGlobalSettings.HotUpdateAssemblies)
        {
